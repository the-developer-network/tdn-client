            ...
            <div className="flex flex-col items-center px-8 md:px-12 py-10">
                ...
                {step === "initial" && (
                    <div className="w-full">
                        {/* Fix: Added text-white to make the title visible */}
                        <h2 className="text-2xl md:text-3xl font-bold mb-8 tracking-tight text-center text-white">
                            Join TDN today
                        </h2>
                        ...
                        <div className="space-y-3.5">
                            ...
                            {/* GitHub Sign In */}
                            <button
                                className="w-full flex items-center justify-center gap-3 bg-zinc-900 text-white font-bold py-3 rounded-full hover:bg-zinc-800 border border-white/10 transition-all duration-200"
                            ...
                            <Button
                                ...
                                className="py-3.5"
                                onClick={() =>
                                    console.log("Next: auth/check flow")
                                }
                            >
                                Create account
                            </Button>
                        ...
                        {/* Agreement Text */}
                        <p className="mt-8 text-[13px] text-white/40 leading-relaxed text-center">
                        ...
                        {/* Login Redirect Link */}
                        <p className="mt-10 text-sm text-white/60 text-center">
...
// Icons remain the same as previous step
const GoogleIcon = () => (
