...
export default function InitialStep({ identifier, isLoading, onChange, onSubmit }: InitialStepProps) {
  return (
    <div className="animate-in fade-in duration-300">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full bg-white text-black font-semibold py-2.5 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-200 transition-colors"
        >
